...
local lock          = "qs -c noctalia-shell ipc call sessionMenu lock"
local notif         = "qs -c noctalia-shell ipc call notifications toggleHistory"
local cliphist      = "qs -c noctalia-shell ipc call plugin:clipper toggle"
local screenshot    = "qs -c noctalia-shell ipc call plugin:screenshot takeScreenshot region"
